...
exports.productDetails = async (req, res) => {
    ...
    let limit = req.query.limit ? req.query.limit : 20000000
...
exports.filterProduct = async (req, res) => {
    ...
    // filter argument
    let findArgs = {}
    for (let key in req.body.filters) {//  for with 'in' is used when key is use 
        if (req.body.filters[key].length > 0) {
            ...
            // category: [mobile, labtop, watches]
            // product_price: [0, 999] 0, 1, 2, 3, 4.... 999
        }
    }
