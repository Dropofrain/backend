...
const { addProduct, productList, productDetails, productByCategory, updateProduct, deleteProduct, filterProduct, findRelated, userProducts } = require('../controller/productController')
...
router.get('/userproduct/:user_id', userProducts)
